...
<div class="row">
    <div class="col-md-6 form-group">
        ...
        <input type="text" id="mtestlimit_measure" name="limit[measure]" class="form-control form-control-sm"
               value="{{$analysisTestLimit->measure}}" aria-describedby="validationMeasure">
        <div id="validationMeasure" class="invalid-feedback">
        </div>
    </div>
</div>
<div id="rangeListOptions">
    @foreach($analysisTestLimit->analysisTestLimitOptions as $analysisTestLimitOption)
        @php
            $tempId = rand(1, 500)
        @endphp
        <div class="border ui-corner-all p-1 mb-1">
            <input type="hidden" name="range[option][{{$tempId}}][id]" value="{{$analysisTestLimitOption->id}}">
            <div class="row">
                <div class="col-md-12">
                    <label>Sexo</label>
                    ...
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="radio" name="range[option][{{$tempId}}][gender]" id="inlineGenderMujer{{$tempId}}" value="mujer"
                               aria-describedby="validationGender{{$tempId}}" @if(strcmp($analysisTestLimitOption->gender, 'mujer') == 0) checked @endif>
                    ...
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="radio" name="range[option][{{$tempId}}][gender]" id="inlineGenderVaron{{$tempId}}" value="hombre"
                               aria-describedby="validationGender{{$tempId}}" @if(strcmp($analysisTestLimitOption->gender, 'hombre') == 0) checked @endif>
                    ...
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="radio" name="range[option][{{$tempId}}][gender]" id="inlineGenderVaronMujer{{$tempId}}" value="hombre y mujer"
                               aria-describedby="validationGender{{$tempId}}" @if(strcmp($analysisTestLimitOption->gender, 'hombre y mujer') == 0) checked @endif>
            ...
            <div class="row">
                <div class="col-md-3 form-group">
                    ...
                    <input type="number" id="mtestrange_option_{{$tempId}}_age_initial" name="range[option][{{$tempId}}][age_initial]"
                           value="{{ $analysisTestLimitOption->age_initial }}" class="form-control form-control-sm" aria-describedby="validationAgeInitial{{$tempId}}">
                ...
                <div class="col-md-3 form-group">
                    ...
                    <input type="number" id="mtestrange_option_{{$tempId}}_age_end" name="range[option][{{$tempId}}][age_end]"
                           value="{{ $analysisTestLimitOption->age_end }}" class="form-control form-control-sm" aria-describedby="validationAgeEnd{{$tempId}}">
                ...
                <div class="col-md-3 form-group">
                    ...
                    <input type="number" id="mtestrange_option_{{$tempId}}_to" name="range[option][{{$tempId}}][to]" class="form-control form-control-sm"
                           value="{{ $analysisTestLimitOption->to }}" aria-describedby="validationTo{{$tempId}}" step="0.001">
                ...
                <div class="col-md-3 form-group">
                    ...
                    <select id="mtestrange_option_{{$tempId}}_bookmark" name="range[option][{{$tempId}}][bookmark]" class="form-control form-control-sm"
                        ...
                        <option value="ROJO" @if($analysisTestLimitOption->bookmark) selected @endif>ROJO</option>
                    </select>
