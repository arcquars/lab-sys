<div class="border ui-corner-all p-1 mb-1">
    ...
    <div class="form-group">
        <label for="mtestrange_option_{{$tempId}}_subtitle">Texto</label>
    ...
    <div class="row">
        <div class="col-md-3 form-group">
            ...
            <input type="number" id="mtestrange_option_{{$tempId}}_age_initial"
                step="0.01"
                name="range[option][{{$tempId}}][age_initial]" class="form-control form-control-sm" aria-describedby="validationAgeInitial{{$tempId}}">
            <div id="validationAgeInitial{{$tempId}}" class="invalid-feedback">
            </div>
        </div>
        <div class="col-md-3 form-group">
            <label for="mtestrange_option_{{$tempId}}_age_end">Edad Final</label>
            <input type="number" id="mtestrange_option_{{$tempId}}_age_end" 
                step="0.01"
                name="range[option][{{$tempId}}][age_end]" class="form-control form-control-sm" aria-describedby="validationAgeEnd{{$tempId}}">
            <div id="validationAgeEnd{{$tempId}}" class="invalid-feedback">
            </div>
        </div>
        <div class="col-md-3 form-group">
            <label for="mtestrange_option_{{$tempId}}_initial">Inicial...</label>
            <input type="number" id="mtestrange_option_{{$tempId}}_initial" name="range[option][{{$tempId}}][initial]" class="form-control form-control-sm"
                   aria-describedby="validationInitial{{$tempId}}" step="0.01">
            <div id="validationInitial{{$tempId}}" class="invalid-feedback">
            </div>
        </div>
        <div class="col-md-3 form-group">
            <label for="mtestrange_option_{{$tempId}}_end">Final</label>
            <input type="number" id="mtestrange_option_{{$tempId}}_end" name="range[option][{{$tempId}}][end]" class="form-control form-control-sm"
                   aria-describedby="validationEnd{{$tempId}}" step="0.01">
