<table style="width: 100%">
    <tr>
        <td width="30%"><p class="p-datos-12"><b>Nombre y Apellido:</b></p></td>
        <td width="30%"><p class="p-datos-12">{{$analisis->person->apellidos.' '.$analisis->person->apellido_materno.', '.$analisis->person->nombres}}</p></td>
        <td width="30%" style="text-align: right;"><p class="p-datos-12"><b>Edad:</b></p></td>
        <td width="30%"><p class="p-datos-12">{{$analisis->person->edad}}</p></td>
    </tr>
    <tr>
