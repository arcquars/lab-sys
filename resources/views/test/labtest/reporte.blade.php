...
<head>
    ...
    @include('test.'.$reportEnterprice.'.partials.reporte-style')
    <style>
        @page {
            @if(isset($watermark))
...
@include('test.'.$reportEnterprice.'.partials.reporte-head')
...
@include('test.'.$reportEnterprice.'.partials.reporte-client', compact('analisis', 'pathQr'))
...
@include('test.'.$reportEnterprice.'.partials.reporte-footer', compact('analisis', 'sin'))
